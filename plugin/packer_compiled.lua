...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    config = { 'require("config/coding.copilot")' },
    loaded = true,
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-treesitter-endwise", "spread.nvim", "nvim-ts-rainbow" },
